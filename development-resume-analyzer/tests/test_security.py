...
from development_resume_analyzer.analyzer import DevelopmentResumeAnalyzer
from development_resume_analyzer.security import (
...
def test_instruction_like_resume_content_is_not_scored_or_repeated(tmp_path):
    ...
    paths = DevelopmentResumeAnalyzer(tmp_path / "out", clock=lambda: FIXED_TIME).analyze(source)
